...
static esp_err_t cmd_handler(httpd_req_t *req){
    ...
    if(!strcmp(variable, "framesize")) {
        ...
        is_LedOn = !is_LedOn;
        digitalWrite(4, is_LedOn ? HIGH : LOW );
        Serial.print("Led is set to ");
        Serial.println(is_LedOn);
    }
...
void startCameraServer(){
   ...
   httpd_uri_t stream_uri = {
    ...
    httpd_uri_t playAll_uri = {
        .uri       = "/playAll",
        .method    = HTTP_GET,
        .handler   = playAll_handler,
        .user_ctx  = NULL
    };
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &start_record_uri);
